      ...
      db.run(
        ...
        function(err) {
          ...
          if (status === 'CONFIRMED') {
            ...
            if (memorialController && memorialController.generateMemorialSpace) {
              const mockReq = { 
              ...
              memorialController.generateMemorialSpace(mockReq, mockRes)
            ...
            console.log(`[Death Report] 사용자 ID ${targetUserId} 사망 확정. 후속 처리 시작.`);
          }
